%% Main Script - Question 3(c) PD Control with Reaction Wheels - WITH Magnetorquer
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PURPOSE:
...
%%% CONSTANTS:
global ATT TORQ;
% Set ATT = "Quaternion" or "DCM" for required attitude 
% parametrization:
ATT = "Quaternion";
...
omega0 = [0.08;                              % initial angular velocity
         -0.1; 
          0.3]; 
C_ba0 = Quaternion2DCM(q0);                  % initial DCM
gammadot0 = [0; 0; 0];                       % initial reaction wheelspeeds
% initial conditions state vector:
if ATT == "Quaternion"
    IC = [R0; V0; q0; omega0; gammadot0];            
elseif ATT == "DCM"
    IC = [R0; V0; C_ba0(:,1); C_ba0(:,2); C_ba0(:,3); omega0; gammadot0];
end
...
tic                                          % start timer 
[t,x_out] = ode45(@ODEs_q3c_WithMagnetorquer,time,IC,tol,const,ATT,TORQ);
toc                                          % end timer
