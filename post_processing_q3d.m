%% Post Processing - Question 3(d) Complementary FIlter
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%                      - 2*r_a(3)*[0, 0, 1] );
    ...
    % Attitude Determination using Complementary Filter:
    q_CF(lv1,:) = x_out(lv1,14:17);             
    N_CF(lv1) = q_CF(lv1,:) * q_CF(lv1,:)' - 1;
    C_ba_CF = Quaternion2DCM(q_CF(lv1,:)');    
    C_ba_CFerr = C_ba_CF*C_ba';                   
    [phi_CFerr,theta_CFerr,psi_CFerr] = DCM2Euler321(C_ba_CFerr);  
    EA_CFerr(lv1,:) = [phi_CFerr theta_CFerr psi_CFerr];    
