%% ODEs Generator - Question 3(a) Quaternion-Based PD Attitude Tracking Control

function  [xDOT] = ODEs_q3a(t,x,const,TORQ)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Adding control torque law:
q_des = [1; 0; 0; 0];
q_err = [(q_des(4)*eye(3)-crossm(q_des(1:3)))    -q_des(1:3);
                     q_des(1:3)'                  q_des(4) ]...
        * x3;

tau_CTRL = -kp*q_err(1:3) -kd*x4; % control torque in 3(a)
