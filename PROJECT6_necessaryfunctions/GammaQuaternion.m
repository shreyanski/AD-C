function [GAMMAb_ba] = GammaQuaternion(q_ba)
%
% FUNCTION PURPOSE:
% [GAMMAb_ba] = GammaQuaternion(q_ba) obtains the Gamma matrix using the 
...
%
% OUTPUT PARAMETERS:
% GAMMAb_ba = Gamma matrix of frame "b" relative to frame "a", resolved in frame b
%             (4x3 matrix)
%
eta = q_ba(4);
eps = q_ba(1:3);
epsCROSS = crossm(eps);
GAMMAb_ba = (1/2) * [eta*eye(3)+epsCROSS; ...
                          -1*eps'       ];
